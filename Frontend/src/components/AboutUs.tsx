      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-center mb-8 md:mb-16">
          ...
          <div className="relative mb-8 md:mb-0">
            ...
            <img
              src="https://automex-bhubaneswar.s3.ap-south-2.amazonaws.com/Frontend/images/Landing_page_images/aboutautomex.png"
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group bg-white p-4 md:p-10 rounded-2xl md:rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] hover:shadow-[0_15px_50px_rgba(199,78,137,0.2)] transition-all duration-500 transform hover:-translate-y-3 border border-gray-100/50 hover:border-pink-200/50 relative overflow-hidden flex flex-col items-center md:items-start text-center md:text-left h-full"
            >
              ...
              <div className="relative w-10 h-10 md:w-14 md:h-14 rounded-xl md:rounded-2xl flex items-center justify-center mb-3 md:mb-8 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 flex-shrink-0"
                style={{
                  background: 'linear-gradient(135deg, #E84057 0%, #C4308A 50%, #8B1FB4 100%)',
                  boxShadow: '0 10px 30px rgba(255, 0, 100, 0.25)'
                }}
              >
                ...
                ></div>
                <feature.icon className="relative w-5 h-5 md:w-7 md:h-7 text-white stroke-[2.5] group-hover:scale-110 transition-transform duration-500" />
              </div>

              {/* Title */}
              <h4 className="relative text-sm md:text-2xl font-bold text-gray-900 mb-2 md:mb-4 tracking-tight group-hover:text-gray-800 transition-colors duration-300">
                {feature.title}
              </h4>

              {/* Description */}
              <p className="relative text-[10px] md:text-base text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300 line-clamp-3 md:line-clamp-none">
                {feature.description}
              </p>

              {/* Decorative corner accent */}
              <div className="absolute bottom-0 right-0 w-16 h-16 md:w-24 md:h-24 bg-gradient-to-tl from-pink-100/40 to-transparent rounded-tl-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-8 md:mt-12 lg:mt-16 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-xl md:rounded-2xl p-6 md:p-8 lg:p-12 text-white">
          ...
          <div className="grid grid-cols-3 gap-2 md:gap-8">
            <div className="text-center">
              <div className="w-8 h-8 md:w-12 md:h-12 mx-auto mb-2 md:mb-4 rounded-lg flex items-center justify-center"
                style={{
                  background: 'linear-gradient(135deg, #E84057 0%, #C4308A 50%, #8B1FB4 100%)',
                  boxShadow: '0 5px 15px rgba(255, 0, 100, 0.25)'
                }}
              >
                <Users className="w-4 h-4 md:w-7 md:h-7 text-white" />
              </div>
              <h4 className="font-bold text-[10px] md:text-xl mb-1 md:mb-2 leading-tight">Customer First</h4>
              <p className="text-[8px] md:text-sm text-gray-300 leading-tight">
            ...
            <div className="text-center">
              ...
              <h4 className="font-bold text-[10px] md:text-xl mb-1 md:mb-2 leading-tight">100% Transparency</h4>
              <p className="text-[8px] md:text-sm text-gray-300 leading-tight">
            ...
            <div className="text-center">
              ...
              >
                <Car className="w-4 h-4 md:w-7 md:h-7 text-white" />
              </div>
              <h4 className="font-bold text-[10px] md:text-xl mb-1 md:mb-2 leading-tight">Free Pick & Drop</h4>
              <p className="text-[8px] md:text-sm text-gray-300 leading-tight">
