...
const Reviews = () => {
  const reviews = [
    {
      title: "Great Experience with GoMechanic",
      ...
      platform: "Twitter",
      workshop: "GoMechanic - Bandra East, Mumbai",
    },
    {
      ...
      platform: "Facebook",
      workshop: "GoMechanic - Wadala East, Mumbai",
    },
    {
      ...
      platform: "Twitter",
      workshop: "GoMechanic - Chandivali, Mumbai",
    },
    {
      ...
      author: "Ankur Singh",
      platform: "Facebook",
      workshop: "GoMechanic - Gandhi Nagar, Mumbai",
    },
  ];
